...
public interface ISystemNavigationProvider
{
	...
	/// <param name="ageHint">A hint from the host that indicates how long ago the plugin should search for data. The default value indicates the plugin should return *all* available data</param>
	/// <returns></returns>
